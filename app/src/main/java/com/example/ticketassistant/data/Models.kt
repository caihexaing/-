...
data class TicketTask(
    ...
    val lastStablePageState: String? = null,
    val lastUnknownReason: String? = null,
    val stationPhase: String? = null,
    val stationQueryInputKey: String? = null,
    val stationQueryWriteSent: Boolean = false,
    val stationQueryConfirmed: Boolean = false,
    val stationCandidateScope: String? = null,
    val stationCandidateCount: Int? = null,
    val stationQueryWriteAt: Long? = null,
    val stationQueryConfirmedAt: Long? = null,
    val stationCandidateObservedAt: Long? = null,
    val lastResultPageAt: Long? = null,
    val lastTargetControlAt: Long? = null,
    val lastTrainActionAt: Long? = null,
    val trainSummaryAttempts: Int = 0,
